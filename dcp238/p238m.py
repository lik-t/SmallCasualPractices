# Problem #238. [Hard]. This problem is asked by MIT.
# Blackjack is a two player card game whose rules are as follows:
# - The player and then the dealer are each given two cards.
# - The plater can then "hit", or ask for arbitrarily many additional cards,
...
# For this problem, ards values are counted as follows: each card between 2 and
